...
const Page = () => {
  ...
  return (
    <div>
      ...
      <div className="absolute top-0  right-0 h-14 w-[550px]">
        <img src={Img1} alt="" />
      </div>

      <div className="absolute top-32  right-40 h-14 w-[550px]">
        <img src={Img2} alt="" />
      </div>

      <div className="absolute top-28  right-28 h-14 w-[550px]">
        <img src={Img3} alt="" />
      </div>
      ...
      <div className="navbar flex justify-around mt-11 relative z-10">
        ...
        <div className="items flex space-x-16 mt-3 mr-7">
...
<div className="main mt-32 ml-28 sm:row lg:normal">
